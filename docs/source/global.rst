...
.. |Model_delete| replace:: :meth:`delete<anom.Model.delete>`
.. |Model_put| replace:: :meth:`put<anom.Model.put>`
...
.. |Query| replace:: :class:`Query<anom.Query>`
.. |Queries| replace:: :class:`Queries<anom.Query>`
